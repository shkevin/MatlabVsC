...
% 319, 320, 321, 417, 479, 480, 511, 512, 639, 640, 767, 768, 769, 1000, 3000, 4000,10000];
sizes = [480, 511, 512, 639, 640, 767, 768, 769, 1000, 3000, 4000,10000];
iterations = flip(floor(sizes/5));
seconds = 0;
