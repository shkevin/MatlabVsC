...
int all_sizes[] = {480,511,512,639,640,767,768,769,1000,3000,4000,10000};
...
int default_sizes[] = {480,511,512,639,640,767,768,769,1000,3000,4000,10000};
...
int main(int argc, char **argv)
{
    ...
    int iterations[] = {2000,800,600,200,153,153,153,128,127,102,102,96};
